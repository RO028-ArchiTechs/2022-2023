...
public class HardwareDrivetrainMecanum
{
		...
		double WHEEL_CIRCUMFERENCE_MM)
	{
		 ...
		 this.frontLeftDrive = hwMap.get(DcMotorEx.class, "FL");
		 this.frontRightDrive = hwMap.get(DcMotorEx.class, "FR");
		 this.backLeftDrive = hwMap.get(DcMotorEx.class, "BL");
		 this.backRightDrive = hwMap.get(DcMotorEx.class, "BR");
